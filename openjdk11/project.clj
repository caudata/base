(defproject hara "3.0.1"
  ...
  :package "config/package.edn"
  
  :deploy  {:all     "config/deploy.all.edn"
            :dev     "config/deploy.dev.edn"
            :public  "config/deploy.public.edn"
            :native  "config/native.edn"}
                      
  :publish {:all     "config/publish.all.edn"
            :dev     "config/publish.dev.edn"
            :public  "config/publish.public.edn"}
